...
export const Albert = localFont({
  src: "../public/fonts/AlbertSans-BoldItalic.ttf",
})
export const Expletus = localFont({
  src: "../public/fonts/ExpletusSans-BoldItalic.ttf",
})
export const Playfair = localFont({
  src: "../public/fonts/PlayfairDisplay-BlackItalic.ttf",
})
